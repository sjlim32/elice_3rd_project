          ...
          <div style={{ height: '600px' }}>
            <EditorForwardRef
              ...
              init={{
                ...
                plugins: 'lists link paste codesample emoticons wordcount',
                menubar: 'insert | format | tools',
                toolbar:
                  'undo redo | blocks | formatselect | bold italic | emoticons codesample | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent ',
              }}
            />
          </div>
        </InputsContainer>
